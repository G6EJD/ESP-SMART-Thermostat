...
Adafruit_BME280 sensor;                // I2C mode for the BME280

// Thingspeak library and credentials
#include "ThingSpeak.h"                // always include thingspeak header file after other header files and custom macros
unsigned long myChannelNumber = 123454678;             // Thingspeak Channel ID number
const char *  myWriteAPIKey   = "SECRET_WRITE_APIKEY"; // Thingspeak Write Key 
...
void setup() {
  ...
  ReadSensor();                                           // Get current sensor values
  ThingSpeak.begin(client);                               // Initialise ThingSpeak service
...
//#########################################################################################
void SendDataToThingSpeak(int field, float value){
...
void ReadSensor() {
  ...
  SendDataToThingSpeak(1, Temperature);
  //SendDataToThingSpeak(2, Humidity); // Add if Humidity to be uploaded
}
//#########################################################################################
...
/*
   Version 1.0 818 lines of code
   All HTML fully validated by W3C
   Added Thingspeak upload capability
*/
